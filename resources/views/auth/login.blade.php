        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 border border-gray-200 dark:border-gray-700">
            ...
            <div
                ...
                <div class="max-h-64 overflow-y-auto p-4 space-y-2">
                    <!-- Admin -->
                    <div class="flex items-center justify-between p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600/50 transition-colors cursor-pointer"
                            ...
                            @if ($institution->users->first())
                                ...
                                <div class="flex items-center justify-between p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600/50 transition-colors cursor-pointer"
                                    ...
                                    <div
                                        ...
                                        <span x-show="!clicked"
                                            class="truncate max-w-[120px]">{{ $user->email }}</span>
                                        <span x-show="clicked" x-transition
