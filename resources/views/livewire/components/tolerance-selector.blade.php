<div x-data="{ isOpen: false }" class="fixed bottom-6 right-6 z-40 font-sans print:hidden">
    ...
    <button x-show="!isOpen" 
            ...
            class="flex items-center gap-3 px-4 py-2.5 
                   ...
                   group text-sm text-neutral-800 dark:text-neutral-200">
        
        <!-- Ikon Slider dengan Aksen Amber Gold -->
        <span class="text-neutral-500 group-hover:text-amber-600 dark:group-hover:text-amber-500 transition-colors">
    ...
    <div x-show="isOpen" 
         ...
         class="w-80 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md 
                border border-neutral-200 dark:border-neutral-800 
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <select wire:model.live="tolerancePercentage"
                class="w-full px-3 py-2 border border-neutral-200 dark:border-neutral-800 rounded-lg 
                       ...
                       text-sm text-neutral-700 dark:text-neutral-200 font-medium">
        ...
        <!-- Indikator Loading -->
        <div wire:loading wire:target="tolerancePercentage" class="flex items-center gap-2 justify-center py-1">
            <svg class="animate-spin h-4 w-4 text-amber-600 dark:text-amber-500" fill="none" viewBox="0 0 24 24">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
            <span class="text-xs text-neutral-500 dark:text-neutral-400 font-medium">Memperbarui...</span>
        </div>
