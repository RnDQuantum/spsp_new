        ...
        <div class="h-full px-4 py-6 overflow-y-auto">
            ...
            <nav class="space-y-2">
                ...
                <a href="#" :class="minimized ? 'justify-center' : ''"
                    class="flex items-center px-4 py-3 text-white bg-gray-700 rounded" title="Dashboard">
                    <svg :class="minimized ? '' : 'mr-3'" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path
