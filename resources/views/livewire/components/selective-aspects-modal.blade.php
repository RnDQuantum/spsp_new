{{-- Selective Aspects Modal - Fixed with Mary UI --}}
<div>
    ...
    <div x-data="selectiveAspectsModal()" x-on:open-selection-modal-instant.window="openModal()"
        ...
        {{-- Mary UI Modal with Fixed Scroll Structure --}}
        <x-mary-modal wire:model="show"
            box-class="relative w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-xl transform transition-all">

            {{-- Flex Container with explicit height --}}
            <div class="flex flex-col max-h-[90vh] overflow-hidden">
                ...
                <div x-show="!loading || dataReady" style="display: none;" class="flex flex-col h-full overflow-hidden">
                    ...
                    {{-- Header - FIXED: flex-shrink-0 instead of sticky --}}
                    <div
                    ...
                    {{-- Body with Scrollable Content - FIXED: flex-1 and overflow-y-auto --}}
                    ...
                    {{-- Enhanced Validation Section - FIXED: flex-shrink-0 --}}
                    <div
                            ...
                            <div class="flex items-center justify-between p-2 rounded-lg transition-all duration-200"
                                ...
                                <div class="flex items-center gap-2">
                                    <svg :class="isValidWeight ? 'text-green-600 dark:text-green-400' : 'text-amber-600 dark:text-amber-400'"
                                        class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" x-show="isValidWeight">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                    ...
                    {{-- Footer - FIXED: flex-shrink-0 instead of sticky --}}
                    <div
                        class="flex-shrink-0 px-6 py-3 flex items-center justify-end bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center gap-3">
                            ...
                            <button wire:click="applySelection" :disabled="!isFullyValid" wire:loading.attr="disabled"
