<div class="mx-auto my-8 shadow overflow-hidden max-w-6xl bg-white dark:bg-gray-800">
    ...
    <div class="p-6 bg-gray-100 dark:bg-gray-700">
        ...
        <table class="w-full text-sm text-gray-900 dark:text-gray-200">
            <tr>
                <td class="py-2 font-semibold text-gray-900 dark:text-gray-200" style="width: 150px;">Formasi Jabatan
                </td>
                <td class="py-2 text-gray-900 dark:text-gray-200" style="width: 20px;">:</td>
        ...
        <table class="w-full text-sm text-gray-900 dark:text-gray-200">
            <tr>
                <td class="py-2 font-semibold text-gray-900 dark:text-gray-200" style="width: 150px;">Standar Penilaian
                </td>
                <td class="py-2 text-gray-900 dark:text-gray-200" style="width: 20px;">:</td>
                <td class="py-2 text-gray-900 dark:text-gray-200">{{ $participant->positionFormation->template->name }}
                </td>
            </tr>
            <tr>
                <td class="py-2 font-semibold text-gray-900 dark:text-gray-200">Tanggal Tes</td>
                <td class="py-2 text-gray-900 dark:text-gray-200">:</td>
                <td class="py-2 text-gray-900 dark:text-gray-200">{{ $participant->assessment_date->format('d F Y') }}
                </td>
            </tr>
        </table>
    </div>
