                            ...
                            <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center gap-3">
                                        <input type="checkbox"
                                            wire:model="aspectConfigs.{{ $aspect['code'] }}.active"
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <input type="number"
                                            wire:model="aspectConfigs.{{ $aspect['code'] }}.weight"
                                            min="0" max="100"
                                        ...
                                        @foreach ($aspect['sub_aspects'] as $subAspect)
                                            <div class="flex items-center justify-between py-1">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <input type="number"
                                                        wire:model="subAspectConfigs.{{ $subAspect['code'] }}.rating"
                                                        min="1" max="5"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <input type="number"
                                            wire:model="aspectConfigs.{{ $aspect['code'] }}.rating"
