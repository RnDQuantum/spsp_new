    ...
    <div class="bg-white dark:bg-[#171412] p-4 md:p-5 rounded-xl border border-warm-border dark:border-[#25211e] shadow-xs">
        ...
        <div class="mb-6 bg-warm-ivory dark:bg-[#1f1b18] p-4 rounded-xl border border-warm-border dark:border-[#25211e]">
            <div class="flex flex-col gap-3.5">
                {{-- Event Filter --}}
                <div class="p-2.5 bg-white dark:bg-[#171412] border border-warm-border dark:border-[#25211e] rounded-lg">
                ...
                <div class="mt-5 flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-warm-border dark:border-[#25211e]">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button type="button"
                            ...
                            <span>🎯 Pilih Aspek Kompetensi</span>
                        </button>
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="font-display text-2xl md:text-3xl font-bold tracking-tight text-primary-ink dark:text-neutral-100 uppercase mb-1">
                Standar Pemetaan Kompetensi Individu
            </h1>
        ...
        {{-- Tabel Detail dengan Sub-Aspects / Aspects --}}
                ...
                <table class="w-full text-sm text-primary-ink dark:text-neutral-100 border-collapse">
                    <thead>
                        <tr class="bg-warm-ivory dark:bg-[#1f1b18] border-b border-warm-border dark:border-[#25211e]">
                            ...
                            <th class="border-r border-warm-border dark:border-[#25211e] px-4 py-3 text-left font-bold text-xs uppercase tracking-wider">ATRIBUT & KOMPETENSI</th>
                        ...
                        @foreach ($categoryData as $catIndex => $category)
                            ...
                            @foreach ($category['aspects'] as $aspectIndex => $aspect)
                                <tr class="hover:bg-warm-ivory/40 dark:hover:bg-[#1f1b18]/40 transition-colors">
                                    ...
                                    <td class="border-r border-warm-border dark:border-[#25211e] px-4 py-2.5 text-sm">
                                        <p class="font-semibold text-primary-ink dark:text-neutral-100 mb-0.5">{{ $aspect['name'] }}</p>
                                        @if (!empty($aspect['description']))
                                            <p class="text-xs text-primary-ink/60 dark:text-neutral-400 font-sans">
                                                {{ $aspect['description'] }}
                                            </p>
                                        @endif
                                    </td>
                                    ...
                                    <td wire:click="openEditAspectRating('{{ $aspect['code'] }}', {{ $aspect['standard_rating'] }})"
                                        class="border-r border-warm-border dark:border-[#25211e] px-4 py-2.5 text-center font-mono-data text-sm cursor-pointer hover:bg-accent-amber/15 dark:hover:bg-amber-900/30 transition-colors {{ $aspect['is_rating_adjusted'] ?? false ? 'bg-amber-100 dark:bg-amber-900/40 font-bold text-amber-900 dark:text-amber-200' : '' }}"
                                        title="{{ $aspect['is_rating_adjusted'] ?? false ? 'Disesuaikan dari ' . $aspect['original_rating'] . ' - Klik untuk edit' : 'Klik untuk edit rating' }}">
                                    ...
                                    <td class="border-r border-warm-border dark:border-[#25211e] px-4 py-2.5 text-center font-mono-data font-bold text-sm">
                                        {{ number_format($aspect['average_rating'], 2) }}
                                    </td>
            ...
            <div x-show="show"
                ...
                <div class="flex items-center justify-between border-b border-warm-border dark:border-[#25211e] bg-warm-ivory dark:bg-[#1f1b18] px-6 py-4">
                    <div>
                        ...
                        <p class="text-xs font-mono-data text-primary-ink/75 dark:text-neutral-400">
                            Sesuaikan nilai rating aspek kompetensi (1 - 5)
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-end gap-3 border-t border-warm-border dark:border-[#25211e] bg-warm-ivory dark:bg-[#1f1b18] px-6 py-3">
                    ...
                    <button type="button" wire:click="saveAspectRating"
                        wire:loading.attr="disabled"
                        wire:target="saveAspectRating"
                        ...
                        <svg wire:loading wire:target="saveAspectRating" class="animate-spin h-3.5 w-3.5 text-white" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                        <span>Simpan</span>
