    ...
    @if ($selectedEvent && $selectedAspect)
        ...
        <table class="w-full border border-black dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm">
            <tr>
                ...
                <td
                    class="border border-black dark:border-gray-600 px-4 py-2 bg-gray-100 dark:bg-gray-800 text-right w-1/2">
                    <span
            ...
            <tr>
                <td
                    class="border border-black dark:border-gray-600 px-4 py-2 bg-red-50 dark:bg-red-900 font-semibold text-red-800 dark:text-red-400 w-1/4">
                    Recommended</td>
                <td
        ...
        <table class="w-full border border-black dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm mt-4">
            <tr>
                ...
                <td
                    class="border border-black dark:border-gray-600 px-4 py-2 text-right bg-gray-100 dark:bg-gray-800 align-middle">
                    <div class="inline-flex items-center gap-2">
                        ...
                        <span x-show="$wire.tolerancePercentage > 0" class="text-xs text-gray-600 dark:text-gray-400">
                            → <span
                                class="font-bold text-yellow-800 dark:text-yellow-400">{{ number_format($standardRating, 2, ',', '.') }}</span>
        ...
        <div class="mt-4 flex flex-wrap items-center justify-between gap-3 text-sm">
            <div class="flex items-center gap-2 mb-3">
                <span class="text-gray-700 dark:text-gray-300">Tampilkan:</span>
