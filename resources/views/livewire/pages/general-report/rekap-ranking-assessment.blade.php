                ...
                @foreach ($conclusionSummary as $conclusion => $count)
                    @php
                        ...
                        $bgColor = match ($conclusion) {
                            ...
                            'Memenuhi Standar' => 'bg-blue-100 dark:bg-blue-900 border-blue-300 dark:border-blue-600',
                            'Di Bawah Standar' => 'bg-red-100 dark:bg-red-900 border-red-300 dark:border-red-600',
                    ...
                    <div class="border-2 {{ $bgColor }} rounded-lg p-4 text-center">
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ $percentage }}%</div>
                        <div class="text-sm text-gray-700 dark:text-gray-300 font-semibold leading-tight mb-2">
                            {{ $conclusion }}
                        </div>
