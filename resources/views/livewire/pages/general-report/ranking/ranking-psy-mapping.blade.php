    ...
    <div class="px-6 pb-6 bg-white dark:bg-gray-900 overflow-x-auto">
        <table
            ...
            <thead>
                ...
                <tr class="bg-gray-200 dark:bg-gray-700">
                    <th class="border-2 border-black dark:border-gray-600 px-3 py-1 font-semibold">Rating
                    </th>
...
$c = trim(strtoupper($row['conclusion'])); @endphp
    ...
    <!-- Pie Chart Section -->
    @if (!empty($conclusionSummary))
    <div class="mt-8 border-t-2 border-black dark:border-gray-600 pt-6 bg-white dark:bg-gray-900" x-data="{
                refreshChart() {
