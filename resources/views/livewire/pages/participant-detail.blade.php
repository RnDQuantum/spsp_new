                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-medium text-gray-900">Ringkasan MC Mapping</h3>
                                    <p class="text-sm text-gray-600">Ringkasan kompetensi dengan kesimpulan</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <p class="text-sm text-gray-600">
                                Laporan ringkasan aspek kompetensi dengan individual rating, standard rating,
                                dan kesimpulan untuk setiap aspek kompetensi.
                            </p>
                        </div>

                        <a href="{{ route('ringkasan_mc_mapping', ['eventCode' => $participant->assessmentEvent->code, 'testNumber' => $participant->test_number]) }}"
                            class="inline-flex items-center px-4 py-2 bg-teal-600 text-white text-sm font-medium rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors">
                            Lihat Ringkasan MC
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 5l7 7-7 7"></path>
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-medium text-gray-900">Ringkasan Assessment</h3>
                                    <p class="text-sm text-gray-600">Ringkasan hasil keseluruhan assessment</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <p class="text-sm text-gray-600">
                                ...
                                kompetensi,
                                bobot penilaian, gap score, dan kesimpulan akhir peserta.
                            </p>
                        </div>

                        <a href="{{ route('ringkasan_assessment', ['eventCode' => $participant->assessmentEvent->code, 'testNumber' => $participant->test_number]) }}"
                            class="inline-flex items-center px-4 py-2 bg-cyan-600 text-white text-sm font-medium rounded-md hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 transition-colors">
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-lg font-medium text-gray-900">Gambaran Ringkasan Laporan Individu?</h3>
                                <p class="text-sm text-gray-600">Visualisasi gambaran ringkasan untuk Potensi,
                                    Kompetensi, dan General Mapping</p>
                            </div>
                        </div>

                        <div class="mb-4">
                            <p class="text-sm text-gray-600">
                                Analisis visual dengan gambaran ringkasan untuk Potensi, Kompetensi, dan General Mapping
                            </p>
                        </div>

                        <a href="#"
                            class="inline-flex items-center px-4 py-2 bg-pink-600 text-white text-sm font-medium rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-colors">
