<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden" wire:init="loadParticipants">
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <!-- Filter Kode Proyek with Mary Choices -->
                <div class="w-full sm:w-[480px]">
                    <x-mary-choices label="Filter Proyek" wire:model.live="selectedEventId"
                        :options="$assessmentEventsSearchable" single searchable search-function="searchEvents"
                        debounce="300ms" min-chars="0" no-result-text="Tidak ada proyek ditemukan..."
                        hint="Ketik untuk mencari proyek" />
                </div>

                <!-- Search -->
                <div class="relative flex-1 sm:flex-initial sm:w-[280px]">
                    <input type="text" wire:model.live.debounce.400ms="search" placeholder="Cari nama atau NIP..."
                        class="w-full rounded-lg border border-gray-300 dark:border-gray-600 pl-10 pr-4 py-2.5 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                ...
                <button wire:click="clearFilters"
                    class="inline-flex items-center justify-center px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all">
    ...
    <div class="relative min-h-[400px]">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @for ($i = 0; $i < 10; $i++) <tr class="animate-pulse">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150"
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                            <div class="flex items-center gap-2">
                                <span class="font-medium">{{ $this->participants->firstItem() + $index }}</span>
                    ...
                    <tr>
                        <td colspan="11" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-1">Tidak ada peserta
                                    ditemukan
                                </p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Coba ubah filter atau kata kunci
                                    pencarian</p>
                            </div>
                        </td>
                    </tr>
        ...
        <div wire:loading.delay.long wire:target="selectedEventId,search,gotoPage,previousPage,nextPage"
            ...
            <div class="flex flex-col items-center space-y-3">
                <svg class="animate-spin h-10 w-10 text-blue-600 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg"
