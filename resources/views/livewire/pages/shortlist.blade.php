    ...
    <div class="relative min-h-[400px]">
                            ...
                            <tr>
                                <td colspan="11" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-1">Tidak ada peserta ditemukan
                                        </p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Coba ubah filter atau kata kunci pencarian</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
        ...
        <div wire:loading.delay.long wire:target="selectedEventId,search,gotoPage,previousPage,nextPage"
            ...
            <div class="flex flex-col items-center space-y-3">
                <svg class="animate-spin h-10 w-10 text-blue-600 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                        stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor"
