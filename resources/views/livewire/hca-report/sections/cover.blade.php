<div class="w-full max-w-4xl mx-auto bg-white border border-warm-border rounded-xl overflow-hidden print:border-none min-h-[900px] flex flex-col justify-between p-12 md:p-16 relative">
    ...
    <div class="my-auto py-12 md:py-20 flex flex-col md:flex-row gap-12 items-start justify-between">
        <div class="w-full md:w-3/5 space-y-6">
            ...
            <h1 class="font-display text-4xl md:text-5xl lg:text-6xl text-primary-ink font-semibold leading-tight">
                Human Capital <br>
                <span class="text-accent-amber italic">Assessment</span> Report
            </h1>
            <div class="h-1.5 w-24 bg-accent-amber rounded-full"></div>
            <p class="text-sm text-slate-500 max-w-md">
                Laporan komprehensif peninjauan kompetensi, potensi, dan kesiapan suksesi kepemimpinan tingkat eksekutif. Dokumen formal untuk keperluan manajemen dan tim Human Resources.
            </p>
        </div>
    ...
    <div class="mt-8 border-t border-warm-border pt-6 flex flex-col sm:flex-row items-center justify-between text-[10px] text-slate-400">
        ...
        <div class="mt-2 sm:mt-0 italic flex items-center gap-1.5">
            ...
            Dibuat secara otomatis & terenkripsi oleh SPSP Engine v4.0
        </div>
    </div>
