...
<body class="bg-warm-ivory dark:bg-[#0f0d0c] h-svh overflow-hidden">
    <div x-data="sidebarState()" 
        ...
        <div id="main-content" class="h-full w-full bg-warm-ivory/90 motion-safe:transition-[margin] motion-safe:duration-250 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-[margin] dark:bg-[#0f0d0c]/90 overflow-y-auto"
