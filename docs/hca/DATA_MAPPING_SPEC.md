...
### 5. Arsitektur Input Data Pelengkap HCA (*Hybrid Two-Tier Entry System*)
HCA Report membutuhkan data pelengkap yang tidak dihasilkan otomatis dari instrumen psikotes dasar SPSP, yaitu:
