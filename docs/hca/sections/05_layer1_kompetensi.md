...
1. **Managerial & Functional Competency Assessment**:
   * Mengukur tingkat kompetensi perilaku yang dapat diamati (*observable behaviors*) sesuai PermenPANRB / standar kompetensi institusi (misal: Integritas, Kerjasama, Komunikasi, Orientasi pada Hasil, Pelayanan Publik, Pengembangan Diri & Orang Lain, Mengelola Perubahan, Pengambilan Keputusan).
