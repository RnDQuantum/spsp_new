...
/**
 * GeneralPsyMapping Component Integration Tests
 *
 * Tests the GeneralPsyMapping Livewire component's integration with
 * the optimized RankingService for individual participant rank (Potensi category).
 *
 * Coverage:
 ...
 */
class GeneralPsyMappingTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_loads_participant_ranking_on_cold_start()
    {
        ...
        $component = Livewire::test(GeneralPsyMapping::class, [
