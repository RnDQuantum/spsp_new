...
## Design Principles
- **Editorial Clarity**: Treat every report screen like a page in a high-end corporate journal, using strong typographic hierarchy.
- **Data with Narrative**: Never display raw data without its corresponding context or insights; data should tell a clear story.
- **Sparing Accents**: Use accent colors (like gold/amber) selectively to guide the eye to key findings, rather than washing out the design.
- **Warm Physicality**: Use warm-tinted darks, ivory backgrounds, and warm borders to evoke the feel of premium physical paper rather than a digital screen.

## Accessibility & Inclusion
- High-contrast text targeting WCAG AA (minimum 4.5:1 ratio) to ensure executive readability.
- Respect user preference for reduced motion (`prefers-reduced-motion`) for any charts or page transition animations.
